...
class RebagScraper:
    ...
    def __init__(self, brand, query, output_dir, query_hash, local=False):
        ...
        self.local = local
        self.search_url = "https://shop.rebag.com/search"
        self.source = "REBAG"
    ...
    def run(self):
        ...
        if self.local:
            ...
            url = f"file:///{os.path.abspath('local_websites/rebag_test.html')}"
        else:
...
if __name__ == "__main__":
    ...
    scraper = RebagScraper(brand, query, output_dir, query_hash)
    scraper.run()
